 ...
 * Functions as the main hub of the class. This is where every other method is used.
 * This method also adds the books isbn and user to a map containing whos currently borrowing the book and the book itself
...
/**
 * @author Viggo Nielsen
 * checks the library list brought along in the loanBook method to see if the book the user wants to borrow even exists
 * @param lib - the library member variable that is a list of books available
 * @param isbn - the books isbn
 * @return - returns null if the book doesnt exist. Otherwise it returns with the isbn and the loan process continues. 
 */
    ...
    /**
     * @author Viggo Nielsen
     * a method that checks if the book is currently borrowed. If it is it will return false, if its not it will return true.
     * @param isbn - the isbn of the book
     * @param user - user who wants to borrow the book
     * @return - returns true if the book is free or false if the book is already borrowed.
     */
    ...
    /**
     * @author Viggo Nielsen
     * decides when the book is to be returned by creating a LocalDate object of teh current date plus 3 weeks (21 days)
